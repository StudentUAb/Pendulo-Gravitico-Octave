...
Este trabalho contou com a colaboração do <strong>Sonia Violante, Cesar Barros e José Manuel</strong>, que contribuiu para a correção do código e para a compreensão de vários conceitos e técnicas em Octave fundamentais para o desenvolvimento deste programa.
